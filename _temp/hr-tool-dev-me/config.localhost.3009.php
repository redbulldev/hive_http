...
$conf=[
    ...
    'ignore'=>["v1/login",'v1/faker/1',"v1/createsg","v1/meta", "v1/mail","v1/request-auto", "v1/release_note","v1/test","v1/test_history", "v1/dashboard", "v1/dashboard_cv", "v1/users", "v1/point", "v1/level"],//Đường dẫn public
