...
$conf=[
    ...
    'ignore'=>["v1/login",'v1/faker/1',"v1/createsg/1","v1/meta","v1/request-auto","v1/mail", "v1/release_note","v1/test","v1/test_history", "v1/dashboard", "v1/dashboard_cv", "v1/type_work", "v1/position_point", "v1/positions", "v1/import","v1/users","v1/cv", "v1/history_search"],//Đường dẫn public
